                        ...
                        <div id="einzug2">

                            {
                                ...
                                <div className="aktiv__circle"></div> <div class="lineV"></div>
                                        <b className="aktiv_name" >{dynamicT.organisation} <hr className="aktiv_line" style={{backgroundColor: "black", border: "none", width: "20px", height: "1px", marginTop: "10px"}}></hr> <div className="aktiv_ort"> {dynamicT.ort}</div></b>
