...
class Page_statistics extends Component {
    ...
    componentDidMount () {
        ...
        if (firstTime.length <= 0) {
            ...
            script2.innerHTML += 'if (document.getElementById("numbers").classList.contains("active")) {animateValue("#percent1", 1500, 56); animateValue("#percent2", 2500, 78);animateValue("#percent3", 1000, 37); animateValue("#percent4", 2000, 60);}';
            script2.innerHTML += 'if (document.getElementById("gewaltNumbers").classList.contains("active")) {animateValue("#percent5", 1500, 50);animateValue("#percent6", 1000, 34); animateValue("#percent7", 1500, 8);}';
